...
# ------------------ CONFIGURATION ------------------
st.set_page_config(page_title="Debkumar Bera Portfolio", layout="wide")
...
with st.sidebar:
    ...
    # Basic Info
    st.title("Debkumar Bera")
    st.write("🌍 Kolkata, India")
    st.write("📧 debkumar.bera24-26@bibs.co.in")
    st.write("📞 7431890819")
...
- *Higher Secondary (Science)* – Rajnagar Union High School (WBCHSE), Paschim Medinipur (2019 – 2021) – 72%
""")
